...
const SubletNFTs = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-4xl font-fragile text-white m-4 flex">Sublet your NFTs</h1>
        <Formik
          initialValues={{
            name: "",
            symbol: "",
        ...
        >
          <Form className="flex flex-col justify-center items-left">
            <label htmlFor="name" className="p-2 text-white font-fragile text-2xl">
              Name
            </label>
            <Field
              id="name"
            ...
            <label htmlFor="symbol" className="p-2 text-white font-fragile text-2xl">
              Symbol
            </label>
            <Field
              id="symbol"
            ...
            <label htmlFor="limit" className="p-2 text-white font-fragile text-2xl">
              Limit
            </label>
            <Field
              id="limit"
            ...
            <label htmlFor="price" className="p-2 text-white font-fragile text-2xl">
              Price
            </label>
            <Field
              id="price"
            ...
            <label htmlFor="duration" className="p-2 text-white font-fragile text-2xl">
              Duration
            </label>
            <Field
              id="duration"
